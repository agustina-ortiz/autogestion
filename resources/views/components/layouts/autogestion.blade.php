...
<html lang="es">
    ...
    <body>
            ...
            <div class="header-right flex items-center gap-2 md:gap-3">
                ...
                <div x-data="{ open: false }" class="relative">
                    ...
                    <div 
                        ...
                        class="absolute right-0 mt-2 w-[200px] bg-white rounded-lg shadow-lg py-1 z-50"
                        style="display: none;"
                    >
                        <a 
                            href="{{ route('perfil') }}" 
                        ...
                        <a 
                            href="https://wa.me/5492324670156"
                            target="_blank"
                            class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 transition-colors flex items-center gap-2"
                        >
                            <svg class="h-4 w-4 text-[#bdd632]" fill="currentColor" viewBox="0 0 24 24">
        ...
        <footer class="no-print hidden lg:flex bottom-0 left-0 right-0 z-50 flex-row justify-between items-center p-4 mt-8 px-20 lg:px-40 bg-[#333333] {{ $noticias ? 'lg:translate-y-6' : '' }}">
            ...
            <div class="flex flex-row items-center gap-4 lg:gap-6">
                ...
                <a href="https://wa.me/5492324670156" target="_blank" class="flex items-center gap-2 text-white hover:opacity-80 transition-opacity">
        ...
        <nav class="mobile-footer no-print lg:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 z-50 shadow-lg">
            <div class="flex justify-around items-center py-2">
                <!-- Inicio/Dashboard -->
                <a href="{{ route('dashboard') }}" class="flex flex-col items-center justify-center flex-1 py-2 {{ request()->routeIs('dashboard') || request()->routeIs('noticia.ver') || request()->routeIs('evaluaciones') ? 'text-[#77BF43]' : 'text-gray-600' }}">
