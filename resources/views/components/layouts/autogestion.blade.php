        ...
        <header class="fixed top-0 left-0 right-0 z-50 bg-[#BED630] shadow-md flex justify-between items-center px-40 py-4">
            ...
            <div class="header-right flex items-center gap-3">
                ...
                <div x-data="{ open: false }" class="relative">
                    <button 
                        @click="open = !open"
                        class="bg-black text-[#bdd632] rounded-full px-3 py-2 hover:bg-gray-800 transition-colors flex items-center gap-2 text-xs font-bold"
                    >
                ...
                <div class="absolute top-0 left-0 right-0 h-[43%] z-0">
                    ...
                    <div class="">
                        <div class="grid grid-cols-2">
                            <!-- Columna Izqquierda: Espacio vacío para la card del empleado -->
                            <div class="bg-[#77BF43]"></div>

                            <!-- Columna Derecha: Noticia -->
                            <div>
                                <!-- Título de la Noticia -->
                                <div class="bg-[#77BF43] px-6 py-4">
                                    ...
                                    <span class="text-xs text-white bg-white bg-opacity-20 px-2 py-1 rounded-full inline-block mt-2">
