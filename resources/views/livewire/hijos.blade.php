<div>
    ...
    <main class="max-w-6xl mx-auto p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            <!-- Planillas -->
            <div class="bg-white rounded-xl shadow-md p-6 border-l-4 border-[#a4d6e7]">
                <div class="flex items-center gap-4 mb-4">
                    <svg class="w-12 h-12 stroke-[#a4d6e7]" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                ...
                <a href="{{ route('planillas') }}" 
                   class="inline-flex items-center px-6 py-2 bg-[#a4d6e7] text-white font-semibold rounded-lg hover:bg-[#8cc4d8] transition-colors shadow-md">
                    Ir a Planillas
