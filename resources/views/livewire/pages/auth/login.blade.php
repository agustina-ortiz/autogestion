...
<div class="max-h-screen flex items-center justify-center bg-gradient-to-r from-[#e8f5df] to-[#f4f9e8] py-6 px-4 sm:px-6 lg:px-8">
    <div class="max-w-md w-full space-y-4">
        ...
        <div class="text-center">
            <div class="mx-auto h-12 w-12 bg-gradient-to-r from-[#77BF43] to-[#BED630] rounded-full flex items-center justify-center shadow-[0_2px_8px_rgba(119,191,67,0.3)]">
        ...
        <div class="bg-white rounded-xl shadow-[0_2px_8px_rgba(0,0,0,0.1)] p-6 space-y-4 border border-gray-100">
            <form wire:submit="login" class="space-y-4">
                ...
                <div>
                    <button 
                        type="submit"
                        class="w-full flex justify-center items-center py-2.5 px-4 border-0 rounded-lg shadow-[0_2px_4px_rgba(119,191,67,0.3)] text-sm font-bold text-white bg-gradient-to-r from-[#77BF43] to-[#BED630] hover:from-[#5da832] hover:to-[#77BF43] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#77BF43] transition-all duration-300 hover:-translate-y-0.5 hover:shadow-[0_4px_8px_rgba(119,191,67,0.5)] uppercase tracking-wide cursor-pointer"
                    >
