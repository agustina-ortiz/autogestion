<div class="min-h-screen">
    <div class="pb-16 sm:p-0 max-w-[1400px] mx-auto">
        ...
        <div class="bg-white rounded-xl shadow-[0_2px_8px_rgba(0,0,0,0.1)] overflow-hidden mb-6">
            <div class="bg-[#77BF43] text-white p-4 px-4 sm:px-6">
                <h2 class="text-lg sm:text-xl font-bold m-0 uppercase">Solicitud de Sueldo por CHEQUE</h2>
            </div>
            <div class="p-4 sm:p-6">
                ...
                <div class="space-y-5 sm:space-y-6">
                    ...
                    {{-- Mensaje importante --}}
                    <div class="bg-red-50 border-l-4 border-red-500 p-4 sm:p-5 rounded">
